...
public class HTExTopUISoundPreview : MonoBehaviour
{
    [Tooltip("音源プレビュPrefab")] public GameObject TopUISoundPreviewPrefab;

    [Tooltip("音源マネージャ")] public HTExSoundManager htexSoundManager;
    ...
    void generateTopUISoundPreviews1LineEqually(int soundCount, float offsetY, Color previewColor, float offsetSize)
    {
        ...
        // 最大角度間隔で並べても、180°以内に収まるか
        float angleInterval = (htexSoundManager.maxAngleInterval * soundCount <= 180f) ? htexSoundManager.maxAngleInterval : 180f / (soundCount - 1);
